...
/**
 * Product import controller factory for XML files.
 *
 * @package Controller
 * @subpackage Jobs
 */
	...
	implements \Aimeos\Controller\Jobs\Common\Factory\Iface
{
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, \Aimeos\Bootstrap $aimeos, string $name = null ) : \Aimeos\Controller\Jobs\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'controller/jobs/product/import/xml/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Controller\\Jobs\\Iface';
		$classname = '\\Aimeos\\Controller\\Jobs\\Product\\Import\\Xml\\' . $name;
		 ...
		 * @see controller/jobs/product/import/xml/decorators/global
		 */
		return self::addControllerDecorators( $context, $aimeos, $controller, 'product/import/xml' );
	}
}
