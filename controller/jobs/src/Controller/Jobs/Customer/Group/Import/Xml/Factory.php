...
/**
 * Customer group import controller factory for XML files.
 *
 * @package Controller
 * @subpackage Jobs
 */
	...
	implements \Aimeos\Controller\Jobs\Common\Factory\Iface
{
	 ...
	 */
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, \Aimeos\Bootstrap $aimeos, $name = null ) : \Aimeos\Controller\Jobs\Iface
	{
		...
		$classname = '\\Aimeos\\Controller\\Jobs\\Customer\Group\\Import\\Xml\\' . $name;
		 ...
		 * @see controller/jobs/customer/import/xml/decorators/global
		 */
		return self::addControllerDecorators( $context, $aimeos, $controller, 'customer/import/xml' );
	}
}
