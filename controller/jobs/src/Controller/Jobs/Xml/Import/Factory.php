	...
	implements \Aimeos\Controller\Jobs\Common\Factory\Iface
{
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, \Aimeos\Bootstrap $aimeos, string $name = null ) : \Aimeos\Controller\Jobs\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'controller/jobs/xml/import/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Controller\\Jobs\\Iface';
		$classname = '\\Aimeos\\Controller\\Jobs\\Xml\\Import\\' . $name;
		 ...
		 * @see controller/jobs/xml/import/decorators/global
		 */
		return self::addControllerDecorators( $context, $aimeos, $controller, 'xml/import' );
	}
}
