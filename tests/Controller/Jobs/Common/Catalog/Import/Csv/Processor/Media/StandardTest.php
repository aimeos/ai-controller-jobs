...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp() : void
	{
		...
		$this->endpoint = new \Aimeos\Controller\Jobs\Common\Catalog\Import\Csv\Processor\Done( $this->context, [] );
	}
	...
	public function testProcess()
	{
		...
		$object = new \Aimeos\Controller\Jobs\Common\Catalog\Import\Csv\Processor\Media\Standard( $this->context, $mapping, $this->endpoint );
	...
	public function testProcessDelete()
	{
		...
		$object = new \Aimeos\Controller\Jobs\Common\Catalog\Import\Csv\Processor\Media\Standard( $this->context, [], $this->endpoint );
	...
	public function testProcessListtypes()
	{
		...
		$this->context->config()->set( 'controller/jobs/catalog/import/csv/processor/media/listtypes', array( 'default' ) );
	...
	{
		return \Aimeos\MShop::create( $this->context, 'catalog' )->create()->setCode( $code );
	}
}
