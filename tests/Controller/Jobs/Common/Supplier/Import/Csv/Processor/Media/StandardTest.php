...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testProcess()
	{
		...
		$object = new \Aimeos\Controller\Jobs\Common\Supplier\Import\Csv\Processor\Media\Standard( $this->context, $mapping, $this->endpoint );
	...
	public function testProcessDelete()
	{
		...
		$object = new \Aimeos\Controller\Jobs\Common\Supplier\Import\Csv\Processor\Media\Standard( $this->context, [], $this->endpoint );
	...
	public function testProcessListtypes()
	{
		...
		$this->context->config()->set( 'controller/jobs/supplier/import/csv/processor/media/listtypes', array( 'default' ) );
