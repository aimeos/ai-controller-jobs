	...
	implements \Aimeos\Controller\Common\Product\Import\Csv\Processor\Iface
{
	...
	private \Aimeos\Controller\Common\Product\Import\Csv\Cache\Catalog\Standard $cache;
	...
	public function process( \Aimeos\MShop\Product\Item\Iface $product, array $data ) : array
	{
		...
		foreach( $this->getMappedChunk( $data, $this->getMapping() ) as $list )
		{
			...
			foreach( explode( $separator, $this->val( $list, 'catalog.code', '' ) ) as $code )
			{
				$code = trim( $code );
				...
				$listItem = $listItem->fromArray( $list )->setRefId( $catid );
