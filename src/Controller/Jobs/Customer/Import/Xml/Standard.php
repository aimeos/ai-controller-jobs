	...
	implements \Aimeos\Controller\Jobs\Iface
{
	...
	protected function domains() : array
	{
		...
		return (array) $this->context()->config()->get( 'controller/jobs/customer/import/xml/domains', $domains );
	}
	 ...
	 *
	 * @param array $nodes List of DOM nodes to import
	 */
	...
	protected function max() : int
	{
		 ...
		 * @see controller/jobs/customer/import/xml/backup
		 */
		return (int) $this->context()->config()->get( 'controller/jobs/customer/import/xml/max-query', 100 );
	}
