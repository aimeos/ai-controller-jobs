	...
	implements \Aimeos\Controller\Jobs\Iface
{
	...
	protected function backup() : string
	{
		 ...
		 */
		$backup = $this->context()->config()->get( 'controller/jobs/supplier/import/xml/backup' );
	...
	protected function import( \Aimeos\MShop\ContextIface $context, string $path )
	{
		...
		$logger->info( sprintf( 'Started supplier import from file "%1$s"', $path ), 'import/xml/supplier' );
		...
		$logger->info( sprintf( 'Finished supplier import from file "%1$s"', $path ), 'import/xml/supplier' );
	}
