	...
	implements \Aimeos\Controller\Jobs\Iface
{
	...
	protected function domains() : array
	{
		 ...
		 * @see controller/jobs/product/export/sitemap/max-items
		 */
		return (array) $this->context()->config()->get( 'controller/jobs/product/export/sitemap/domains', ['text'] );
	}
	...
	protected function max() : int
	{
		 ...
		 */
		return (int) $this->context()->config()->get( 'controller/jobs/product/export/sitemap/max-items', 10000 );
	}
